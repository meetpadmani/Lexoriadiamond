...
<style>
    ...
    .auth-image-side {
        ...
        background-image: 
            linear-gradient(rgba(15, 31, 23, 0.8), rgba(15, 31, 23, 0.8)),
        ...
        <div class="form-container">
            ...
            <form action="{{ route('password.update') }}" method="POST">
                ...
                <div class="premium-field">
                    ...
                    <input type="password" name="password" class="premium-input" placeholder="Create new password" required>
                </div>

                <div class="premium-field">
                    <label class="premium-label">Confirm Password</label>
                    <input type="password" name="password_confirmation" class="premium-input" placeholder="Repeat new password" required>
                </div>

                <button type="submit" class="btn-rajwadi">Reset Password</button>
            </form>
        </div>
    </div>
</section>
