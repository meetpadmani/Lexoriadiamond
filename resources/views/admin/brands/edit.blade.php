    ...
    <div class="premium-page-header fade-in-up">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-4">
            <div class="d-flex align-items-center gap-4">
                ...
                <div>
                    <h2 class="fw-bolder text-dark mb-1" style="font-family: 'Playfair Display', serif; letter-spacing: -0.5px;">Edit Brand Partner</h2>
                    <p class="text-secondary mb-0 fs-6">Update details for {{ $brand->name }}</p>
                </div>
            </div>
            ...
            <div class="col-lg-8 fade-in-up" style="animation-delay: 0.1s;">
                ...
                <div class="premium-panel">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" class="form-control-studio fw-bold" value="{{ $brand->name }}" required>
                    </div>

                    <div class="mb-4">
                        <label class="form-label-studio">Brand Description</label>
                        <textarea name="description" class="form-control-studio" rows="4">{{ $brand->description }}</textarea>
                    </div>
                </div>
                ...
                <div class="premium-panel fade-in-up" style="animation-delay: 0.2s;">
                    ...
                    <div class="visual-asset-box mb-4" onclick="document.getElementById('logoInput').click()">
                        @php
                            $logoSrc = $brand->logo ? (str_starts_with($brand->logo, 'http') ? $brand->logo : asset('storage/' . $brand->logo)) : 'https://placehold.co/300x150/f8f9fa/adb5bd?text=No+Logo';
                        @endphp
                        <img src="{{ $logoSrc }}" id="logoPreview" onerror="this.src='https://placehold.co/300x150/f8f9fa/adb5bd?text=No+Logo'">
                        <div class="visual-asset-text">
                            <h6>Replace Brand Logo</h6>
                            <p id="fileNameDisplay">Leave blank to keep the current logo. (PNG/SVG preferred)</p>
                        </div>
                    </div>
                ...
                <div class="premium-panel bg-light border-0 fade-in-up" style="animation-delay: 0.3s;">
                    ...
                    <div class="row g-4 mt-1">
                        <div class="col-md-6">
                            ...
                            <input type="number" name="order" class="form-control-studio bg-white" value="{{ $brand->order }}">
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-center justify-content-between p-3 rounded-3 bg-white border">
                                ...
                                <div class="form-check form-switch fs-4 m-0">
                                    <input class="form-check-input" type="checkbox" name="is_active" {{ $brand->is_active ? 'checked' : '' }} style="cursor: pointer;">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-5 text-end">
                        <button type="submit" class="btn btn-premium px-5 w-100 fs-5">
                            <i class="bi bi-cloud-arrow-up-fill me-2"></i> Save Updates
                        </button>
                    </div>
                </div>
