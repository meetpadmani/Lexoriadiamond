...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Your wishlist is full of timeless elegance. Are you ready to make one of these masterpieces yours?</p>
            ...
            <center>
                <a href="{{ route('wishlist.index') }}" class="cta-btn">VIEW MY WISHLIST</a>
            </center>

            <p style="margin-top: 30px;">These pieces are handcrafted with love and wait for their rightful owner.</p>
        </div>
        <div class="footer">
