...
<div class="d-flex justify-content-between align-items-center mb-5">
    <div class="d-flex align-items-center gap-3">
        ...
        <div>
            <h3 class="mb-1 fw-bold text-dark">Create Coupon</h3>
            <p class="text-secondary small mb-0">Generate a new discount code for your customers.</p>
        </div>
    </div>
</div>
            ...
            <form action="{{ route('admin.coupons.store') }}" method="POST">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="code" class="form-control" value="{{ old('code') }}" placeholder="e.g. SUMMER50" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" name="value" class="form-control" value="{{ old('value') }}" placeholder="Enter discount value" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" step="0.01" name="min_purchase_amount" class="form-control" value="{{ old('min_purchase_amount', 0) }}" required>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" name="usage_limit" class="form-control" value="{{ old('usage_limit') }}" max="2147483647" placeholder="Leave blank for unlimited">
                    ...
                    <div class="col-md-12 mt-4">
                        <div class="p-4 bg-primary-subtle rounded-4 border border-primary-subtle">
                            <div class="form-check form-switch mb-3 d-flex align-items-center">
                                <input class="form-check-input me-3" type="checkbox" name="is_one_time" value="1" id="is_one_time" style="width: 40px; height: 20px;" {{ old('is_one_time') ? 'checked' : '' }}>
                    ...
                    <div class="col-md-12 mt-4 text-end">
                        ...
                        <button type="submit" class="btn btn-premium fw-bold px-5">Save Coupon</button>
                    </div>
                </div>
            </form>
        </div>
